...
const Home = () => {
    ...
    const orderCount = data?.order_counts;
    const productCount = data?.product_counts;
            ...
            <section id="blog" className="container">
                ...
                <div id="posts">
                    ...
                    <div className="post">
                        ...
                        <div className="post-info">
                            <h3 className="post-title">Lorem ipsum dolor sit amet consectetur.</h3>
                            <p className="post-abstract">Lorem ipsum dolor sit amet consectetur. Eget arcu velit tempor ut nunc. Eucrasmagna eget posueresed.</p>
                            <span className="post-author">
                                <p className="time">10 min</p>
                                <p className="author">
                                    <img className="author-pic" src="/images/blog/avatar.png" alt="" />
